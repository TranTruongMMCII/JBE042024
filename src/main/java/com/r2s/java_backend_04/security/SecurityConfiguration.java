package com.r2s.java_backend_04.security;
...
public class SecurityConfiguration {
	...
	private static final String[] WHITE_LIST = { "/auth/**", /* /v3/api-docs/** */ "/api-docs/**", "/swagger-ui/**" };
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(
				auths -> auths.requestMatchers(WHITE_LIST).permitAll().requestMatchers("/users/**", "/profiles/**")
						.hasAnyAuthority("ADMIN", "USER").requestMatchers("/addresses/**").hasAnyAuthority("ADMIN")
